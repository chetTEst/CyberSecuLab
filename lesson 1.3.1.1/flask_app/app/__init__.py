...
def create_app():
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://lesson1311:lesson1311@localhost:33061/lesson1311' #'sqlite:///' + pjoin(path, 'tmp', 'lesson.db') #'mysql+pymysql://lesson1311:lesson1311@localhost:33061/lesson1311'
