    ...
    function checkAnswers() {
        ...
        if (allCorrect) {
            $.ajax({
                ...
                dataType: 'json',
                success: function() {
                    showToastMessage("Поздравляем! Все ответы верны. Вы успешно справились с задачей Системного администратора по защите вычислительной сети. Так держать!", "success");
                    return false;
                },
                error: function() {
            ...
            showToastMessage("Странно, но ответ не правильный. Посмотрите внимательней. Возможно где-то осталась чрезмерная нагрузка, ну или вы отключили наших важных клиентов!", "danger");
            return false;
        }
    }